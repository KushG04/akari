...
public class ControllerImpl implements ClassicMvcController {
    ...
    public void clickPrevPuzzle() {
        int currentIndex = model.getActivePuzzleIndex();
        int prevIndex = (currentIndex - 1 + model.getPuzzleLibrarySize()) % model.getPuzzleLibrarySize();
    ...
    public void clickCell(int r, int c) {
        ...
        } else if (model.isLit(r, c) || model.getActivePuzzle().getCellType(r, c) == CellType.CORRIDOR) {
            model.addLamp(r, c);
        }
    }
}
